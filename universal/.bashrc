...
#display startx prompt on longs and Xanadu when logging in to a tty
if [[ -z $DISPLAY && $HOSTNAME == "longs" || -z $DISPLAY && $HOSTNAME == "Xanadu" || -z $DISPLAY && $HOSTNAME == "Paradisio" ]]; then
